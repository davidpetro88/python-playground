...
acerto_de_um = list(validacao_marcacoes).count('sim')
acerto_de_zero = list(validacao_marcacoes).count('nao')
# acerto_de_zero = len(Y[Y=='nao'])
taxa_de_carto_base = 100.0 * max(acerto_de_um, acerto_de_zero) / len(validacao_marcacoes)
